              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'The client app will validate this payload and complete verification automatically if it matches the current request.',
                      textAlign: TextAlign.center,
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            '${request.pendingCounts.totalPending} pending item${request.pendingCounts.totalPending == 1 ? '' : 's'}',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Manual fallback verification code',
